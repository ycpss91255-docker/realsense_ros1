...
# symlink (default target config/realsense/yaml/none.yaml, EMPTY = stock
...
# upstream defaults; --build-arg CAMERA_CONFIG=config/realsense/yaml/usb2_640x480p15fps.yaml
