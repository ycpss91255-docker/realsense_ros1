...
#
# config/realsense/99-realsense-libusb.rules is a vendored copy of the SDK's
...
readonly SCRIPT_DIR
readonly RULES_LOCAL="${SCRIPT_DIR}/../config/realsense/99-realsense-libusb.rules"
...
Verify that config/realsense/99-realsense-libusb.rules contains every device
